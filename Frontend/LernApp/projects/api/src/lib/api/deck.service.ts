...
// @ts-ignore
import { DeckResponseModel } from '../model/deck-response-model';
// @ts-ignore
...
export class DeckService implements DeckServiceInterface {
     ...
     */
    public apiDecksDeckIdGet(requestParameters: ApiDecksDeckIdGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<DeckResponseModel>;
    public apiDecksDeckIdGet(requestParameters: ApiDecksDeckIdGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<DeckResponseModel>>;
    public apiDecksDeckIdGet(requestParameters: ApiDecksDeckIdGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<DeckResponseModel>>;
    public apiDecksDeckIdGet(requestParameters: ApiDecksDeckIdGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/decks/${this.configuration.encodeParam({name: "deckId", value: deckId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        return this.httpClient.request<DeckResponseModel>('get', `${this.configuration.basePath}${localVarPath}`,
            {
